...
namespace Ranger.Services.Integrations.Data
{
    public interface IIntegrationsRepository : IRepository
    {
        ...
        Task<IEnumerable<IDomainIntegration>> GetAllNotDeletedDefaultIntegrationsByEnvironmentForProject(Guid projectId, EnvironmentEnum environment, CancellationToken cancellationToken = default(CancellationToken));
